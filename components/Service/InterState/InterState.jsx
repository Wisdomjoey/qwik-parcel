		...
		<div className='interState'>
			...
			<Container
				...
				txt="
					...
					and labelling policies, are just a few of the issues you may face. Qwik Parcel 
					will ensure that your shipment follow correct protocol from pickup to delivery, 
